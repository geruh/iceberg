...
import org.apache.iceberg.inmemory.VersionedInMemoryCatalog;
...
public class TestVersionedRESTCatalog extends CatalogTransactionTests<RESTCatalog> {
  private RESTCatalog catalog;
  private VersionedInMemoryCatalog backendCatalog;
  ...
  public void before() throws Exception {
    this.backendCatalog = new VersionedInMemoryCatalog();
    File warehouse = temp.toFile();
    this.backendCatalog.initialize(
        "in-memory",
        ImmutableMap.of(CatalogProperties.WAREHOUSE_LOCATION, temp.toFile().getAbsolutePath()));
