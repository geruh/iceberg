...
public interface SupportsCatalogTransactions {
  ...
  /**
   * Begin a {@link CatalogTransaction} with the given {@link IsolationLevel}.
   *
  ...
  /** Load a table in the context of a transaction. */
  Table loadTableInTransaction(TableIdentifier identifier, String transactionId);
}
